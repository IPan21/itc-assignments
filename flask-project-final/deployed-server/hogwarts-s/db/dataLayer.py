...
# mongodb://heroku_d555m8n2:vgtuidcblhui52k6l1l335i8v4@ds151247.mlab.com:51247/heroku_d555m8n2

class DataLayer:

    def __init__(self, app):
        self.__client = pymongo.MongoClient('mongodb://heroku_d555m8n2:vgtuidcblhui52k6l1l335i8v4@ds151247.mlab.com:51247/heroku_d555m8n2?retryWrites=false')
        # self.__db = self.__client["hogwarts"]
        # self.__users = self.__client["hogwarts"]
        self.__mongo = PyMongo(app)
        self.__db = self.__mongo.db
        # self.__users = self.__client
